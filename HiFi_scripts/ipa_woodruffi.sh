...
ipa dist -i $File --nthreads 4 --njobs 4 --run-dir $dir --cluster-args 'sbatch -J woodruffi.{rule} -t 3-00:00:00 -c {params.num_threads} -e ipa_%j.err -o ipa_%j.out -p cmecpu1 -q cmeqos'
