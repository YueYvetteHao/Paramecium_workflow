...
#SBATCH -n 55                       # number of CPU cores to reserve on this compute node
...
#cd /scratch/yhao38/calkinsi_nophase/asm_s_0.1/purge_dups
#gfatools gfa2fa calkinsi_purge.asm.bp.p_ctg.gfa > calkinsi_purge.asm.bp.p_ctg.fasta
#pri_asm=calkinsi_purge.asm.bp.p_ctg.fasta

cd /scratch/yhao38/canucalk
pri_asm=asm.contigs.fasta
pb=calkinsi.fastq.gz
